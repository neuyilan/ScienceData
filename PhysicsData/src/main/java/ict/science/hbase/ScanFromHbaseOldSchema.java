...
public class ScanFromHbaseOldSchema {

	private static Configuration conf;
	private static String tableNameStr = "tag_old_schema";
	...
	static String wFileName = "query_hbase_old_schema.csv";
...
//		String tempSql = "select eventId from tag2  where runNo= '-8126' and totalCharged ='5'";
//		select eventId from tag2  where runNo= '-8126' and totalTrks ='48'
		...
		while ((tempSql = br.readLine()) != null) {
			...
			String endRowStr = "softNo#0#runNo#" + runNoValue + "#" + attr + "#"+ attrValue + "#a";
